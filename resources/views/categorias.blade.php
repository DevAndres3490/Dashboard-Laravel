                            ...
                            <div class="mb-md-4 mt-md-3 pb-3">
                                ...
                                <div data-mdb-input-init class="form-outline form-white mb-2">
                                    <input name="name" type="text" id="name"
                                        class="form-control form-control-lg shadow-lg" value="{{ old('name') }}" required/>
                            ...
                            <div class="modal fade" id="editRoleModal{{ $categoria->id }}" data-bs-backdrop="static"
                                ...
                                <div class="modal-dialog text-center">
                                    <div class="modal-content text-center">
                                        ...
                                        <div class="modal-body">
                                            <form id="createForm" action="{{ route('categorias.update', $categoria->id) }}" method="POST" class="row g-3 needs-validation" novalidate>
                                                @csrf
                                                @method('PUT')
                                                <div class="mb-md-4 mt-md-3 pb-3">
